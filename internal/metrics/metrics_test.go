...
func TestAllMetricsRegistered(t *testing.T) {
	// Verify all 8 metrics are registered by attempting to re-register each
	...
	collectors := map[string]prometheus.Collector{
		...
		"email_alerts_sent_total":          pkgmetrics.EmailAlertsSentTotal,
		"email_alerts_failed_total":        pkgmetrics.EmailAlertsFailedTotal,
