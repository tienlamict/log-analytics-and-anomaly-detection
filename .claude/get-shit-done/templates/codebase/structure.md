...
- Usage: Reference from command with `@D:/Project/Golang/log-analytics-and-anomaly-detection/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Project/Golang/log-analytics-and-anomaly-detection/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Project/Golang/log-analytics-and-anomaly-detection/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
